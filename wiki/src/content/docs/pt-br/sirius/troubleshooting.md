...
description: Problemas comuns na instalação com o Sirius — autenticação polkit, discos que não aparecem, e requisitos de RAM.
sidebar:
  order: 5
---
...
[Visão geral → modelo de privilégios](/pt-br/sirius/overview/#modelo-de-privilégios)).
...
O menu suspenso de discos da tela de armazenamento filtra discos que estão
...
[Diagnóstico → require vs. warn](/pt-br/sirius/diagnostics/#require-vs-warn)),
