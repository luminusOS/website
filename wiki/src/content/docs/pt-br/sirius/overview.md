...
Veja [Adaptando o Sirius para outra distro](/pt-br/sirius/adapting/) se foi
...
1. **Boas-vindas**
2. **Diagnóstico** — verificações de hardware, veja [Diagnóstico](/pt-br/sirius/diagnostics/)
3. **Rede** (some automaticamente se o NetworkManager não reportar um dispositivo Wi-Fi)
4. **Teclado**
5. **Fuso horário**
6. **Armazenamento** — disco e particionamento, veja [Armazenamento](/pt-br/sirius/storage/)
7. **Usuário**
8. **Resumo**
9. **Progresso**
10. **Concluído**
