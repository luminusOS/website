...
const en = {
  ...
  auroraPage: {
    ...
    spotlights: [
      ...
      {
        tag: 'Tray Icons',
        title: 'Background apps, visible again',
        body: 'A real system tray for SNI app icons and GNOME background apps, with smart deduplication so the panel stays useful instead of noisy.',
        file: 'tray-icons.png',
      },
    ],
...
const ptBr: typeof en = {
  ...
  auroraPage: {
    ...
    spotlights: [
      ...
      {
        tag: 'Tray Icons',
        title: 'Apps em segundo plano, visíveis de novo',
        body: 'Uma bandeja de sistema de verdade para ícones SNI e apps em segundo plano do GNOME, com deduplicação inteligente para o painel continuar útil em vez de barulhento.',
        file: 'tray-icons.png',
      },
    ],
